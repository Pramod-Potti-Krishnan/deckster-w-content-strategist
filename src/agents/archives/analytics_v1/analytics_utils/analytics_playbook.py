"""
Analytics Playbook Module
=========================

LLM-based chart selection playbook for intelligent analytics generation.
Converted from analytics_playbook.md with structured rules and specifications.

This module provides:
- Chart specifications with when_to_use rules
- Data requirements for each chart type
- Synthetic data generation parameters
- Plotting API specifications
...
# ============================================================================
# ANALYTICS PLAYBOOK - Complete Chart Specifications
# ============================================================================
    ...
    "charts": {
        "line_chart": {
            ...
            "plotting_api": {
                "function": "plt.plot",
                "required_params": ["x", "y"],
                "optional_params": ["label", "linewidth", "marker", "linestyle"]
            },
        ...
        "step_chart": {
            ...
            "plotting_api": {
                "function": "plt.step",
                "required_params": ["x", "y"],
                "optional_params": ["where", "linewidth"]
            },
        ...
        "area_chart": {
            ...
            "plotting_api": {
                ...
                "required_params": ["x", "y1"],
                "optional_params": ["y2", "alpha"]
            },
        ...
        "stacked_area_chart": {
            ...
            "plotting_api": {
                "function": "plt.stackplot",
                "required_params": ["x", "ys"],
                "optional_params": ["labels", "alpha"]
            },
        ...
        "bar_chart_vertical": {
            ...
            "plotting_api": {
                "function": "plt.bar",
                "required_params": ["x", "height"],
                "optional_params": ["width", "label"]
            },
        ...
        "bar_chart_horizontal": {
            ...
            "plotting_api": {
                "function": "plt.barh",
                "required_params": ["y", "width"],
                "optional_params": ["height", "label"]
            },
        ...
        "grouped_bar_chart": {
            ...
            "plotting_api": {
                "function": "plt.bar (offset groups)",
                "required_params": ["x_positions_per_group", "heights"],
                "optional_params": ["bar_width", "labels", "legend"]
            },
        ...
        "stacked_bar_chart": {
            ...
            "plotting_api": {
                "function": "plt.bar (bottom stacking)",
                "required_params": ["x", "segment_heights"],
                "optional_params": ["labels", "percent_mode"]
            },
        ...
        "histogram": {
            ...
            "plotting_api": {
                ...
                "optional_params": ["bins", "density", "range", "cumulative"]
            },
        ...
        "box_plot": {
            ...
            "plotting_api": {
                ...
                "optional_params": ["labels", "vert", "showfliers"]
            },
        ...
        "violin_plot": {
            ...
            "plotting_api": {
                "function": "plt.violinplot",
                "required_params": ["dataset"],
                "optional_params": ["showmeans", "showmedians", "vert"]
            },
        ...
        "scatter_plot": {
            ...
            "plotting_api": {
                ...
                "required_params": ["x", "y"],
                "optional_params": ["s", "alpha", "label", "marker"]
            },
        ...
        "bubble_chart": {
            ...
            "plotting_api": {
                "function": "plt.scatter",
                "required_params": ["x", "y", "s"],
                "optional_params": ["alpha", "label"]
            },
        ...
        "hexbin": {
            ...
            "plotting_api": {
                "function": "plt.hexbin",
                "required_params": ["x", "y"],
                "optional_params": ["gridsize", "C", "reduce_C_function"]
            },
        ...
        "heatmap": {
            ...
            "plotting_api": {
                ...
                "optional_params": ["aspect", "interpolation", "vmin", "vmax"]
            },
        ...
        "error_bar_chart": {
            ...
            "plotting_api": {
                ...
                "required_params": ["x", "y", "yerr"],
                "optional_params": ["fmt", "capsize"]
            },
        ...
        "waterfall": {
            ...
            "plotting_api": {
                "function": "plt.bar (manual bottoms)",
                "required_params": ["x", "heights", "bottoms"],
                "optional_params": ["color_scheme_for_pos_neg"]
            },
        ...
        "pareto": {
            ...
            "plotting_api": {
                "function": "plt.bar + ax.twinx().plot",
                "required_params": ["sorted_x", "sorted_height", "cumulative_percent"],
                "optional_params": ["reference_line_80"]
            },
        ...
        "gantt": {
            ...
            "plotting_api": {
                "function": "ax.broken_barh",
                "required_params": ["xranges", "yrange"],
                "optional_params": ["facecolors"]
            },
        ...
        "radar_chart": {
            ...
            "plotting_api": {
                "function": "polar_axes.plot/fill",
                "required_params": ["angles", "values"],
                "optional_params": ["fill_alpha", "gridlines"]
            },
        ...
        "control_chart": {
            ...
            "plotting_api": {
                "function": "plt.plot + plt.fill_between",
                "required_params": ["x", "y"],
                "optional_params": ["mean_line", "ucl", "lcl"]
            },
        ...
        "funnel": {
            ...
            "plotting_api": {
                "function": "plt.barh (centered, decreasing widths)",
                "required_params": ["y", "widths"],
                "optional_params": ["left_offsets", "percent_labels"]
            },
...
def get_all_chart_names() -> List[str]:
    """Get a list of all available chart names in the playbook."""
    return list(ANALYTICS_PLAYBOOK["charts"].keys())


def get_chart_spec(chart_name: str) -> Optional[Dict[str, Any]]:
    """
    Get the complete specification for a chart type.
    
    Args:
        chart_name: Name of the chart (e.g., 'line_chart', 'bar_chart_vertical')
        
    Returns:
        Chart specification dictionary or None if not found
    """
    return ANALYTICS_PLAYBOOK["charts"].get(chart_name)


def get_charts_by_renderer(renderer: str) -> List[Dict[str, Any]]:
    """
    Get all charts that use a specific renderer.
    
    Args:
        renderer: Renderer type ('matplotlib' or 'mermaid')
        
    Returns:
        List of chart specifications
    """
    charts = []
    for chart_spec in ANALYTICS_PLAYBOOK["charts"].values():
        if chart_spec.get("renderer") == renderer:
            charts.append(chart_spec)
    return charts


def get_chart_when_to_use(chart_name: str) -> List[str]:
    """
    Get the when_to_use rules for a specific chart.
    
    Args:
        chart_name: Name of the chart
        
    Returns:
        List of when_to_use rules or empty list if not found
    """
    chart_spec = get_chart_spec(chart_name)
    if chart_spec:
        return chart_spec.get("when_to_use", [])
    return []


def get_chart_data_requirements(chart_name: str) -> List[Dict[str, Any]]:
    """
    Get the data requirements for a specific chart.
    
    Args:
        chart_name: Name of the chart
        
    Returns:
        List of data requirement specifications
    """
    chart_spec = get_chart_spec(chart_name)
    if chart_spec:
        return chart_spec.get("data_requirements", [])
    return []


def get_chart_synthetic_features(chart_name: str) -> Dict[str, Any]:
    """
    Get the synthetic data generation features for a chart.
    
    Args:
        chart_name: Name of the chart
        
    Returns:
        Synthetic data features dictionary
    """
    chart_spec = get_chart_spec(chart_name)
    if chart_spec:
        return chart_spec.get("synthetic_data_features", {})
    return {}


def get_chart_plotting_api(chart_name: str) -> Dict[str, Any]:
    """
    Get the plotting API specification for a chart.
    
    Args:
        chart_name: Name of the chart
        
    Returns:
        Plotting API specification dictionary
    """
    chart_spec = get_chart_spec(chart_name)
    if chart_spec:
        return chart_spec.get("plotting_api", {})
    return {}


def find_charts_for_intent(intent_keywords: List[str]) -> List[str]:
    """
    Find charts that match specific intent keywords.
    
    Args:
        intent_keywords: List of keywords to match against when_to_use rules
        
    Returns:
        List of matching chart names
    """
    matching_charts = []
    
    for chart_name, chart_spec in ANALYTICS_PLAYBOOK["charts"].items():
        when_to_use = " ".join(chart_spec.get("when_to_use", [])).lower()
        
        # Check if any keyword matches
        for keyword in intent_keywords:
            if keyword.lower() in when_to_use:
                matching_charts.append(chart_name)
                break
    
    return matching_charts


def get_matplotlib_charts() -> List[str]:
    """Get all charts that use matplotlib renderer."""
    return [name for name, spec in ANALYTICS_PLAYBOOK["charts"].items() 
            if spec.get("renderer") == "matplotlib"]


def get_mermaid_charts() -> List[str]:
    """Get all charts that use mermaid renderer."""
    return [name for name, spec in ANALYTICS_PLAYBOOK["charts"].items() 
            if spec.get("renderer") == "mermaid"]


def validate_playbook() -> bool:
    """
    Validate the playbook structure to ensure all required fields are present.
    
    Returns:
        True if valid, False otherwise
    """
    required_fields = ["name", "renderer", "when_to_use", "data_requirements", 
                      "plotting_api", "synthetic_data_features"]
    
    try:
        for chart_name, chart_spec in ANALYTICS_PLAYBOOK["charts"].items():
            for field in required_fields:
                if field not in chart_spec:
                    logger.error(f"Chart '{chart_name}' missing required field: {field}")
                    return False
        
        logger.info(f"Playbook validated successfully with {len(ANALYTICS_PLAYBOOK['charts'])} charts")
        return True
...
# ============================================================================
# CHART SELECTION MAPPING (for backward compatibility)
# ============================================================================

# Map old ChartType enum values to new playbook chart names
CHART_TYPE_TO_PLAYBOOK_MAP = {
    "LINE": "line_chart",
    ...
    "BUBBLE": "bubble_chart",
    "WATERFALL": "waterfall",
    "TREEMAP": None,  # Not in playbook yet
    "GANTT": "gantt",
    "FUNNEL": "funnel",
    "PARETO": "pareto",
...
def map_chart_type_to_playbook(chart_type: str) -> Optional[str]:
    """
    Map an old ChartType enum value to the new playbook chart name.
    
    Args:
        chart_type: Old chart type string (e.g., 'LINE', 'BAR')
        
    Returns:
        Playbook chart name or None if not mapped
    """
    return CHART_TYPE_TO_PLAYBOOK_MAP.get(chart_type.upper())


# Validate playbook on module load
if __name__ != "__main__":
    if not validate_playbook():
        logger.warning("Analytics playbook validation failed - some features may not work correctly")